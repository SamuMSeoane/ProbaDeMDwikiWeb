...
Con este proyecto pretendo comprobar si puedo generar una web sencilla a partir de la última versión del mdwiki-0.7.0
...
La web [rosettaonline.net](https://www.rosettaonline.net) ya está operativa (con oportunos cambios respecto del código que se presenta aquí).
